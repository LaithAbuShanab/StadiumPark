            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                        <a href="{{url('admin/employee/get')}}" class="btn btn-info round text-white  dropdown-menu-right box-shadow-2 px-2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group text-white" role="group" aria-label="Second Group">
                                                            <a href="{{url('admin/employee/get/'.$employee->id)}}" class="btn btn-icon btn-success">
                                                                <i class="la la-edit"></i>
                                                            </a>
                                                            <a href="{{url('admin/employee/delete/'.$employee->id)}}" class="btn btn-icon btn-danger">
