                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="hour_count">Number Of Hours</label>
                                                            <input type="number" value="{{old('hour_count',isset($hour)? $hour->hour_count : '')}}" step="any" id="hour_count" autocomplete="off" class="form-control" placeholder="Number Of Hours" name="hour_count">
                                                            @if ($errors->has('hour_count'))
                                                                <span class="text-danger">{{$errors->first('hour_count')}}</span>
                                                            @endif
                                                        </div>
                                                    </div>
