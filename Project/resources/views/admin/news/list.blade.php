            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                        <a href="{{url('admin/news/get')}}" class="btn btn-info round text-white  dropdown-menu-right box-shadow-2 px-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="users-contacts" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
                                                ...
                                                <tr>
                                                    <td>{{$post->id}}</td>
                                                    <td><img width="30" height="30" src="{{empty($post->image) ? avatar('noimage.jpeg') : asset($post->image)}}"></td>
                                                    <td>{{$post->title}}</td>
                                                    <td>{{$post->content}}</td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group text-white" role="group" aria-label="Second Group">
                                                            <a href="{{url('admin/news/get/'.$post->id)}}" class="btn btn-icon btn-success">
                                                                <i class="la la-edit"></i>
                                                            </a>
                                                            <a href="{{url('admin/news/delete/'.$post->id)}}" class="btn btn-icon btn-danger">
